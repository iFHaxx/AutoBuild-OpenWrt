...
# CONFIG_PACKAGE_luci-i18n-accesscontrol-en is not set
# CONFIG_PACKAGE_luci-i18n-arpbind-en is not set
# CONFIG_PACKAGE_luci-i18n-autoreboot-en is not set
...
# CONFIG_PACKAGE_luci-i18n-diskman-en is not set
# CONFIG_PACKAGE_luci-i18n-filetransfer-en is not set
...
# CONFIG_PACKAGE_luci-i18n-quickstart-zh-cn is not set
# CONFIG_PACKAGE_luci-i18n-qmodem-sms-en is not set
# CONFIG_PACKAGE_luci-i18n-qmodem-en is not set
# CONFIG_PACKAGE_luci-i18n-quickstart-en is not set
...
# CONFIG_PACKAGE_luci-i18n-turboacc-en is not set
...
# CONFIG_PACKAGE_vsftpd-altis not set
...
# CCONFIG_PACKAGE_samba4-libs is not set
# CCONFIG_PACKAGE_samba4-server is not set
# CCONFIG_SAMBA4_SERVER_WSDD2 is not set
# CCONFIG_SAMBA4_SERVER_NETBIOS is not set
# CCONFIG_SAMBA4_SERVER_AVAHI is not set
# CCONFIG_SAMBA4_SERVER_VFS is not set
...
# end of Select shadow utilities
